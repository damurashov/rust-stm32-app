...
pub const APSR_N_POS: usize = 31usize;
pub const APSR_N_MSK: usize = 1usize << APSR_N_POS;
pub const APSR_Z_POS: usize = 30usize;
pub const APSR_Z_MSK: usize = 1usize << APSR_Z_POS;
pub const APSR_C_POS: usize = 29usize;
pub const APSR_C_MSK: usize = 1usize << APSR_C_POS;
pub const APSR_V_POS: usize = 28usize;
pub const APSR_V_MSK: usize = 1usize << APSR_V_POS;
pub const IPSR_ISR_POS: usize = 0usize;
pub const IPSR_ISR_MSK: usize = 0x1FFusize;
pub const XPSR_N_POS: usize = 31usize;
pub const XPSR_N_MSK: usize = 1usize << XPSR_N_POS;
pub const XPSR_Z_POS: usize = 30usize;
pub const XPSR_Z_MSK: usize = 1usize << XPSR_Z_POS;
pub const XPSR_C_POS: usize = 29usize;
pub const XPSR_C_MSK: usize = 1usize << XPSR_C_POS;
pub const XPSR_V_POS: usize = 28usize;
pub const XPSR_V_MSK: usize = 1usize << XPSR_V_POS;
pub const XPSR_T_POS: usize = 24usize;
pub const XPSR_T_MSK: usize = 1usize << XPSR_T_POS;
pub const XPSR_ISR_POS: usize = 0usize;
pub const XPSR_ISR_MSK: usize = 0x1FFusize;
pub const CONTROL_SPSEL_POS: usize = 1usize;
pub const CONTROL_SPSEL_MSK: usize = 1usize << CONTROL_SPSEL_POS;
pub const SCB_CPUID_IMPLEMENTER_POS: usize = 24usize;
pub const SCB_CPUID_IMPLEMENTER_MSK: usize = 0xFFusize << SCB_CPUID_IMPLEMENTER_POS;
pub const SCB_CPUID_VARIANT_POS: usize = 20usize;
pub const SCB_CPUID_VARIANT_MSK: usize = 0xFusize << SCB_CPUID_VARIANT_POS;
pub const SCB_CPUID_ARCHITECTURE_POS: usize = 16usize;
pub const SCB_CPUID_ARCHITECTURE_MSK: usize = 0xFusize << SCB_CPUID_ARCHITECTURE_POS;
pub const SCB_CPUID_PARTNO_POS: usize = 4usize;
pub const SCB_CPUID_PARTNO_MSK: usize = 0xFFFusize << SCB_CPUID_PARTNO_POS;
pub const SCB_CPUID_REVISION_POS: usize = 0usize;
pub const SCB_CPUID_REVISION_MSK: usize = 0xFusize;
pub const SCB_ICSR_NMIPENDSET_POS: usize = 31usize;
pub const SCB_ICSR_NMIPENDSET_MSK: usize = 1usize << SCB_ICSR_NMIPENDSET_POS;
pub const SCB_ICSR_PENDSVSET_POS: usize = 28usize;
pub const SCB_ICSR_PENDSVSET_MSK: usize = 1usize << SCB_ICSR_PENDSVSET_POS;
pub const SCB_ICSR_PENDSVCLR_POS: usize = 27usize;
pub const SCB_ICSR_PENDSVCLR_MSK: usize = 1usize << SCB_ICSR_PENDSVCLR_POS;
pub const SCB_ICSR_PENDSTSET_POS: usize = 26usize;
pub const SCB_ICSR_PENDSTSET_MSK: usize = 1usize << SCB_ICSR_PENDSTSET_POS;
pub const SCB_ICSR_PENDSTCLR_POS: usize = 25usize;
pub const SCB_ICSR_PENDSTCLR_MSK: usize = 1usize << SCB_ICSR_PENDSTCLR_POS;
pub const SCB_ICSR_ISRPREEMPT_POS: usize = 23usize;
pub const SCB_ICSR_ISRPREEMPT_MSK: usize = 1usize << SCB_ICSR_ISRPREEMPT_POS;
pub const SCB_ICSR_ISRPENDING_POS: usize = 22usize;
pub const SCB_ICSR_ISRPENDING_MSK: usize = 1usize << SCB_ICSR_ISRPENDING_POS;
pub const SCB_ICSR_VECTPENDING_POS: usize = 12usize;
pub const SCB_ICSR_VECTPENDING_MSK: usize = 0x1FFusize << SCB_ICSR_VECTPENDING_POS;
pub const SCB_ICSR_VECTACTIVE_POS: usize = 0usize;
pub const SCB_ICSR_VECTACTIVE_MSK: usize = 0x1FFusize;
pub const SCB_AIRCR_VECTKEY_POS: usize = 16usize;
pub const SCB_AIRCR_VECTKEY_MSK: usize = 0xFFFFusize << SCB_AIRCR_VECTKEY_POS;
pub const SCB_AIRCR_VECTKEYSTAT_POS: usize = 16usize;
pub const SCB_AIRCR_VECTKEYSTAT_MSK: usize = 0xFFFFusize << SCB_AIRCR_VECTKEYSTAT_POS;
pub const SCB_AIRCR_ENDIANESS_POS: usize = 15usize;
pub const SCB_AIRCR_ENDIANESS_MSK: usize = 1usize << SCB_AIRCR_ENDIANESS_POS;
pub const SCB_AIRCR_SYSRESETREQ_POS: usize = 2usize;
pub const SCB_AIRCR_SYSRESETREQ_MSK: usize = 1usize << SCB_AIRCR_SYSRESETREQ_POS;
pub const SCB_AIRCR_VECTCLRACTIVE_POS: usize = 1usize;
pub const SCB_AIRCR_VECTCLRACTIVE_MSK: usize = 1usize << SCB_AIRCR_VECTCLRACTIVE_POS;
pub const SCB_SCR_SEVONPEND_POS: usize = 4usize;
pub const SCB_SCR_SEVONPEND_MSK: usize = 1usize << SCB_SCR_SEVONPEND_POS;
pub const SCB_SCR_SLEEPDEEP_POS: usize = 2usize;
pub const SCB_SCR_SLEEPDEEP_MSK: usize = 1usize << SCB_SCR_SLEEPDEEP_POS;
pub const SCB_SCR_SLEEPONEXIT_POS: usize = 1usize;
pub const SCB_SCR_SLEEPONEXIT_MSK: usize = 1usize << SCB_SCR_SLEEPONEXIT_POS;
pub const SCB_CCR_STKALIGN_POS: usize = 9usize;
pub const SCB_CCR_STKALIGN_MSK: usize = 1usize << SCB_CCR_STKALIGN_POS;
pub const SCB_CCR_UNALIGN_TRP_POS: usize = 3usize;
pub const SCB_CCR_UNALIGN_TRP_MSK: usize = 1usize << SCB_CCR_UNALIGN_TRP_POS;
pub const SCB_SHCSR_SVCALLPENDED_POS: usize = 15usize;
pub const SCB_SHCSR_SVCALLPENDED_MSK: usize = 1usize << SCB_SHCSR_SVCALLPENDED_POS;
pub const SYSTICK_CTRL_COUNTFLAG_POS: usize = 16usize;
pub const SYSTICK_CTRL_COUNTFLAG_MSK: usize = 1usize << SYSTICK_CTRL_COUNTFLAG_POS;
pub const SYSTICK_CTRL_CLKSOURCE_POS: usize = 2usize;
pub const SYSTICK_CTRL_CLKSOURCE_MSK: usize = 1usize << SYSTICK_CTRL_CLKSOURCE_POS;
pub const SYSTICK_CTRL_TICKINT_POS: usize = 1usize;
pub const SYSTICK_CTRL_TICKINT_MSK: usize = 1usize << SYSTICK_CTRL_TICKINT_POS;
pub const SYSTICK_CTRL_ENABLE_POS: usize = 0usize;
pub const SYSTICK_CTRL_ENABLE_MSK: usize = 1usize;
pub const SYSTICK_LOAD_RELOAD_POS: usize = 0usize;
pub const SYSTICK_LOAD_RELOAD_MSK: usize = 0xFFFFFFusize;
pub const SYSTICK_VAL_CURRENT_POS: usize = 0usize;
pub const SYSTICK_VAL_CURRENT_MSK: usize = 0xFFFFFFusize;
pub const SYSTICK_CALIB_NOREF_POS: usize = 31usize;
pub const SYSTICK_CALIB_NOREF_MSK: usize = 1usize << SYSTICK_CALIB_NOREF_POS;
pub const SYSTICK_CALIB_SKEW_POS: usize = 30usize;
pub const SYSTICK_CALIB_SKEW_MSK: usize = 1usize << SYSTICK_CALIB_SKEW_POS;
pub const SYSTICK_CALIB_TENMS_POS: usize = 0usize;
pub const SYSTICK_CALIB_TENMS_MSK: usize = 0xFFFFFFusize;
pub const SCS_BASE: usize = 0xE000E000usize;
pub const SYSTICK_BASE: usize = SCS_BASE + 0x0010usize;
pub const NVIC_BASE: usize = SCS_BASE + 0x0100usize;
pub const SCB_BASE: usize = SCS_BASE + 0x0D00usize;
pub const NVIC_USER_IRQ_OFFSET: usize = 16;
pub const EXC_RETURN_HANDLER: usize = 0xFFFFFFF1usize;
pub const EXC_RETURN_THREAD_MSP: usize = 0xFFFFFFF9usize;
pub const EXC_RETURN_THREAD_PSP: usize = 0xFFFFFFFDusize;
